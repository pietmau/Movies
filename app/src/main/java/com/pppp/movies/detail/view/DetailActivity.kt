...
class DetailActivity : AppCompatActivity(), DetailsView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (application as App).applicationComponent.with(DetailModule()).inject(this)
        when {
    ...
    private fun getfavouriteDrawable(isFavourite: Boolean) =
            if (isFavourite) findDrawable(R.drawable.ic_favorite_red_24dp) else findDrawable(R.drawable.ic_favorite_border_red_24dp)
